...
data class Book(
        ...
        @field:Json(name = "saleInfo") val saleInformation: SaleInformation?
)
...
data class SaleInformation(
        ...
        @field:Json(name = "retailPrice") val retailPrice: BookPrice?,
        @field:Json(name = "listPrice") val listPrice: BookPrice?,
        @field:Json(name = "buyLink") val buyLink: String?
)
...
data class BookPrice(
        ...
        @field:Json(name = "currencyCode") val currency: String
)
